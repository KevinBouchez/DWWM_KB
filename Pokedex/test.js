...
<input type="text" class="search-box" placeholder="Recherche"></input>
<i class="fas fa-search"></i>
`;

// ==============================================================================================================================
// Cela n'utilise qu'une seule récupération, mais les résultats ne seront affichés que lorsque tous les pokémons seront récupérés
// ==============================================================================================================================

async function getPokemons(pokemonStartID, pokemonEndID) {
	// Ajout du load de debut de page
	pokemonContainer.innerHTML = `<span class="loader"></span>`;

	// Restreindre les clics sur les boutons
	buttons.forEach((el) => {
	...
	// Arret du load de debut de page

    ...
    <div class="panier">
        ...
        <table>
            ...
            <?php 
              ...
              $ids = array_keys($_SESSION['UG-Site']);
              ...
              if(empty($ids)){
                ...
                foreach($products as $product):
                    ...
                    $total = $total + $product['price'] * $_SESSION['UG-Site'][$product['id']] ;
                ?>
                <tr>
            ...
            <tr class="total">
                <th>Total : <?=$total?>€</th><a class="btn-payer" href="./payment.php">Payer</a>
            </tr>
        </table>
        </section>
        </div>
